...
import { useSystemStats } from '@/hooks/useLiveData';
      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        >
          ...
          <span className="text-green-400 text-sm font-medium">
            <span className="text-white font-bold tabular-nums">
              {formatNumber(stats.onlineAgents)}
            </span> agents online now
          </span>
        </motion.div>
        ...
        >
          {[
            ...
            { 
              value: '$' + formatNumber(stats.agentEconomy), 
              label: 'Agent Economy', 
              color: 'text-fuchsia-400',
              live: false 
            },
            { 
              value: formatNumber(stats.mcpServers), 
              label: 'MCP Servers', 
              color: 'text-pink-400',
              live: false 
            },
            ...
            <div key={stat.label} className="text-center">
              <div className={`text-3xl font-bold ${stat.color} flex items-center justify-center gap-2`}>
                {stat.value}
                {stat.live && (
